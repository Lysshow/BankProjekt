...
public class FrontController extends HttpServlet {
  ...
  public FrontController() {
    ...
    commands.put("details-accounts", new ListDetailsAccountsCommand("account-details.jsp"));
    commands.put("list-customers", new ListCustomersCommand("customer-list.jsp"));
    commands.put("transfer", new PrepareTransferCommand("transferForm.jsp"));
    commands.put("transferMoney", new TransferCommand("account-list.jsp"));
